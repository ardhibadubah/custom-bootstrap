import { Accordion, Alert, Badge, Button, ButtonGroup, Card, Col, Container, Dropdown, Form, Row } from "react-bootstrap";
      ...
      <Row>
        <Col>
          ...
          <section className="mb-3">
            ...
            <Button variant="outline-secondary" size="sm">Small Button</Button> {' '}
